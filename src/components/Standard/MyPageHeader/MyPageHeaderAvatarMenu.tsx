...
import { MyAvatar, MyBox, MyDivider, MyIconButton, MyListItemIcon, MyListItemText, MyMenu, MyMenuItem } from '../../Basic';
...
const MyPageHeaderAvatarMenu = ({ avatarMenuList, onMenuItemClick }: MyPageHeaderAvatarMenuProps) => {
